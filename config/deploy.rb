...
set :domain, '192.168.150.130'
set :deploy_to, '/var/www/fragments'
set :repository, 'git@github.com:narrativeandplay/fragments.git'
...
# Optional settings:
set :user, 'xerafion'    # Username in the server to SSH to.
