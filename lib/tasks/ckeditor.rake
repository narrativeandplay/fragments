namespace :ckeditor do
  ...
  task :create_nondigest_assets do
    ...
    for file in Dir['public/assets/ckeditor/contents-*.css', 'public/assets/ckeditor/skins/kama/skin-*.js', 'public/assets/ckeditor/skins/kama/editor-*.js', 'public/assets/ckeditor/skins/kama/*.png']
